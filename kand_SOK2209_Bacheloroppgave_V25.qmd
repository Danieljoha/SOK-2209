...
# 2. Problemstilling (dersom denne ikke allerede har blitt definert)


# 3. Tidligere forskning


## 3.1 (Relevant til temaet)
• Definisjon/forklaring av hva begrepene betyr
• Forklaring av hvorfor dette er viktig for samfunnet

## 3.2 (Relevant til problemstillingen)
...
trur kanskje vi ender med en diffligning som me solow
sia vi kan da si at sykefravær forklares av ditt å datt, og mange av ditt og datt forklares av formuenivå så de får egene ligninger som for eks motivasjon kan være funksjon av formue, alder og utdanning eller noe for eks
...
etterspørsel av sykefravær er da en diffligning 


g = formue, j = alder, k = utdanning, l = motivasjon

$$
t^a = h* - \alpha w - \beta(m(g) + h^*w) - (l(g)+k(g)+j(g))
$$
