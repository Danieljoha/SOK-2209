...
Vi kommer til å bruke flere variabler fra levekårsundersøkelsen for å analysere sammenhengen mellom formue og sykefravær. Vi vil bruke både avhengige og uavhengige variabler, latente[^4] variabler, samt kontrollvariabler for å kontrollere for andre faktorer som kan påvirke sykefraværet.
...
$$ Forventer vi at: H1: $\beta_1 > 0$ (høyere jobbkrav gir høyere sykefravær)

H2: $\beta_2 < 0$ (høyere jobbressurser gir lavere sykefravær)

H3: $\beta_3 < 0$ (høyere formuenivå gir lavere sykefravær)

Av de modererende variablene forventer vi at H4: $\beta_4 < 0$ Høyere formuenivå demper de negative effektene til høyere jobbkrav. $$
