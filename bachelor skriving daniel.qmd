...
Vi vil bruke flere kontrollvariabler for å kontrollere for andre faktorer som kan påvirke sykefraværet.

Alder:

Alder ved utgangen av 2022

Kjønn: 

(Kjønn til respondenten)

Utdanning: 

(Utdanningsnivå til respondenten)
Tilfredshet med arbeid: 

(Selvrapportert tilfredshet med arbeid)

Motivasjon: 

(Selvrapportert motivasjon på jobb)
Barn: 
...
Eventuelt ta med andre variabler her, og også ta å definere de bedre utifra hvilke variabler som går inn i hvilken del til jobbressurser, jobbkrav og motivasjon.
